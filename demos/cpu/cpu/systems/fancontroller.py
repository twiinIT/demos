...
class FanController(System):
    ...
    def setup(self):
        ...
        self.add_inward("low_threshold", 303.15, unit="K", desc="Low to medium temperature threshold")
        self.add_inward("high_threshold", 333.15, unit="K", desc="Medium to high temperature threshold")
